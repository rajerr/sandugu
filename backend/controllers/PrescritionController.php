...
use backend\models\PrescritionSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * PrescritionController implements the CRUD actions for Prescription model.
 */
class PrescritionController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new PrescritionSearch();
